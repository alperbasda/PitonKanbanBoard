                    ...
                    this.jKanban = function () {
                        ...
                        arguments[0] &&
                                    ...
                                    ((b.drakeBoard = b
                                        ...
                                        (b.drake = b
                                            ...
                                            .on("drop", function (e, t, n, r) {
                                                ...
                                                void 0 !== o.dragTo && -1 === o.dragTo.indexOf(t.parentNode.dataset.id) && t.parentNode.dataset.id !== n.parentNode.dataset.id && b.drake.cancel(!0),
                                                    null !== e && (!1 === b.options.dropEl(e, t, n, r) && b.drake.cancel(!0), e.classList.remove("is-moving"), "function" == typeof e.dropfn && e.dropfn(e, t, n, r));
                                            })));
                            }),
                            ...
                            (this.addElement = function (e, t) {
                                ...
                                return (
                                    r.classList.add("kanban-item"),
                                    console.log(t),
                                    void 0 !== t.id && "" !== t.id && r.setAttribute("data-eid", t.id),
                                    (r.innerHTML = t.title),
                                    (r.clickfn = t.click),
                                    (r.dragfn = t.drag),
                                    (r.dragendfn = t.dragend),
                                    (r.dropfn = t.drop),
                                    E(r, t),
                                    y(r),
                                    n.appendChild(r),
                                ...
                                for (var i in e) {
                                    ...
                                    t || b.options.boards.push(a),
                                        ...
                                        ("" === b.container.style.width
                                            ? (b.container.style.width = parseInt(n) + 2 * parseInt(b.options.gutter) + "px")
                                            : (b.container.style.width = parseInt(b.container.style.width) + parseInt(n) + 2 * parseInt(b.options.gutter) + "px"));
                                    var c = document.createElement("div");
                                    (c.dataset.id = a.id),
                                        (c.dataset.order = b.container.childNodes.length + 1),
                                        c.classList.add("kanban-board"),
                                        b.options.responsivePercentage ? (c.style.width = n + "%") : (c.style.width = n),
                                    ...
                                    if (
                                        (u.classList.add("kanban-board-header"),
                                            d.map(function (e) {
                                                u.classList.add(e);
                                            }),
                                            (u.innerHTML = '<div class="kanban-title-board">' + a.title + "</div>"),
                                            r)
                                    ) {
                                    ...
                                    for (var v in (p.map(function (e) {
                                        ...
                                        g.classList.add("kanban-item"),
                                            m.id && (g.dataset.eid = m.id),
                                            (g.innerHTML = m.title),
                                            (g.clickfn = m.click),
                                            (g.dragfn = m.drag),
                                            (g.dragendfn = m.dragend),
                                            (g.dropfn = m.drop),
                                            E(g, m),
                                            y(g),
                                            f.appendChild(g);
                ...
                (function (o) {
                    ...
                    function d(e, t, n) {
                        var r = (function (e, t, n) {
                            var r, o;
                            for (r = 0; r < u.length; r++) if ((o = u[r]).element === e && o.type === t && o.fn === n) return r;
                        })(e, t, n);
                        if (r) {
                            var o = u[r].wrapper;
                ...
                (function (o) {
                    ...
                    function H(e, t, n, r) {
                        o.navigator.pointerEnabled
                            ? Y[t](e, { mouseup: "pointerup", mousedown: "pointerdown", mousemove: "pointermove" }[n], r)
                            : o.navigator.msPointerEnabled
                                ? Y[t](e, { mouseup: "MSPointerUp", mousedown: "MSPointerDown", mousemove: "MSPointerMove" }[n], r)
                                : (Y[t](e, { mouseup: "touchend", mousedown: "touchstart", mousemove: "touchmove" }[n], r), Y[t](e, n, r));
                    }
                    function U(e) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        void 0 === T.moves && (T.moves = V),
                            ...
                            void 0 === T.mirrorContainer && (T.mirrorContainer = F.body);
                        var C = M({
                                        ...
                                        (g = ee("pageX", e) - o.left),
                                            ...
                                            (function () {
                                                ...
                                                ((p = m.cloneNode(!0)).style.width = $(e) + "px"),
                                                    ...
                                                    H(R, "add", "mousemove", q),
                                                    j.add(T.mirrorContainer, "gu-unselectable"),
                        ...
                        function S(e) {
                            ...
                            })(e.item, e.source) || ((w = e.item.cloneNode(!0)), C.emit("cloned", w, e.item, "copy")),
                                (v = e.source),
                                (m = e.item),
                                (b = y = Z(e.item)),
                                (C.dragging = !0),
                        ...
                        function _() {
                            var e = w || m;
                            B(),
                                p && (j.rm(T.mirrorContainer, "gu-unselectable"), H(R, "remove", "mousemove", q), J(p).removeChild(p), (p = null)),
                                e && j.rm(e, "gu-transit"),
                                n && clearTimeout(n),
                                (C.dragging = !1),
                                E && C.emit("out", e, E, v),
